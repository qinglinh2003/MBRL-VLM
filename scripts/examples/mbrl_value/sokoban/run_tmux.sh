...
# Level 2: MBRL Imagined Value Estimation (tmux launcher)
...
echo "-----------------------------------------"
echo "Port: $PORT | CUDA: $CUDA_DEVICES"
echo "Server: $SERVER_SESSION | Train: $TRAIN_SESSION"
echo "-----------------------------------------"
echo "tmux attach-session -t $SERVER_SESSION"
echo "tmux attach-session -t $TRAIN_SESSION"
